    ...
    tabPanel(
      ...
      dashboardPage(
        ...
        dashboardBody(  
          ...
          #block 1
          div (style = "display:inline-block; vertical-align:top; padding-top: 0px;margin-bottom:20px; margin-left:0px; ",
               actionBttn('submit_query_binding', 'Go', size = "xs",
                          style = "unite", color = "success",  icon = icon("thumbs-up")),
               actionBttn('clear_filters_binding', 'Reset all', size = "xs", style = "jelly", color = "danger",
                          icon = icon("refresh"))
          ),
          
          br(),
          
          div (style = "display:inline-block; vertical-align:top; padding-top: 0px;margin-bottom:15px; margin-left:0px; ",
               actionBttn('switch_p1p2', 'Switch', size = "xs",
                          style = "unite", color = "warning",  icon = icon("arrows-alt-h"))
          ),
          ...
          div(style = "display:inline-block;vertical-align:top; margin-bottom:0px;font-size:16px;margin-top:-10px",
              ...
              div(
                style = "margin-top:0px;",
                selectInput("p1unit_metric", label = div (style = "font-size:14px;", "Select unit for partner 1"),
              ...
              div(
                style = "margin-top:0px;",
                selectInput("p1unit_molar", label = div (style = "font-size:14px;", "Select unit for partner 1"),
              ...
              div(
                ...
                sliderInput("rec_range",  label = div (style = "font-size:14px;","Concentration range to plot (log units)"),
                            min=-6, max=6, value=c(-2,2), step=1, ticks = F )
              ),
              ...
              div(
                ...
                numericInput("plot_start_p1", label = HTML("Plot start"), value = -2)
              ),
              
              div(
                style = "width:75px; display:inline-block;margin-top:-10px;margin-right:20px",
                numericInput("plot_end_p1", label = HTML("Plot end"), value = 2 )
              ),
              div(
              ...
              vertical-align:top;margin-right:20px",
                ...
                numericInput("plot_interval_p1", label = HTML("Plot interval (x-axis)"), min = 0.1,
                             max = 1, value = 1, step = 0.1)
              ),
          ...
          div( style = "display: inline-block;vertical-align:top; margin-bottom:0px;font-size:16px;margin-top:-10px",
               ...
               div(
                 style = "margin-top:0px;",
                 selectInput("p2unit_metric", label = div (style = "font-size:14px; ", "Select unit for partner 2"),
                             choices = list( "mg/ml", "ug/ml", "ng/ml","pg/ml"),
                             selected = "pg/ml")
               ),
               ...
               div(
                 style = "margin-top:0px;",
                 selectInput("p2unit_molar", label = div (style = "font-size:14px; ", "Select unit for partner 2"),
                             choices = list("fM" , "pM" , "nM" , "uM" , "mM" ),
                             selected = "pM")
               ),
               div(
               ...
               div(
                 ...
                 sliderInput("lig_range", label = div (style = "font-size:14px; ","Concentration range to plot (log units)"), min = -6,
                             max = 6, step = 1, value = c(-4, 2),ticks = F )
               ),
          ...
          div(style = "display: inline-block;vertical-align:top; margin-bottom:0px;font-size:16px;margin-top:-10px",
              ...
              div(
                ...
                sliderInput("kd_range", label = div (style = "font-size:12px;", HTML("K<sub>D</sub> range to plot (log units)")), min = -6,
                            max = 6, value = c(-4, 2), step=1, ticks = F )
              ),
      ...
      dashboardPage(
        ...
        dashboardBody(
          ...
          "))
            ...
            div (style = "display:inline-block; vertical-align:top; padding-top: 0px;margin-bottom:10px; margin-left:0px; ",
                 actionBttn('switch_p1p2_CT', 'Switch', size = "xs",
                            style = "unite", color = "warning",  icon = icon("arrows-alt-h"))
            ),
            ...
            div(style = "display:inline-block;vertical-align:top; margin-bottom:0px;font-size:16px;margin-top:0px; margin-right:10px",
                ...
                div(
                  style = "margin-top:0px;",
                  selectInput("p1unit_CT_metric", label = div (style = "font-size:14px;", "Select unit for partner 1"),
                              choices = list( "mg/ml", "ug/ml", "ng/ml","pg/ml"),
                              selected = "pg/ml")
                ),
                ...
                div(
                  style = "margin-top:0px;",
                  selectInput("p1unit_CT_molar", label = div (style = "font-size:14px;", "Select unit for partner 1"),
                              choices = list("fM" , "pM" , "nM" , "uM" , "mM" ),
                              selected = "pM")
                ),
        ...
        )#end competition body
      ) ## end competition dashboard page
    ), ## end competition tab
    actionButton("dwnld_manual", "Manual", icon = icon("download"),
               style = "position: absolute; top: 5px; right: 5px; z-index:10000;",
               onclick = "window.open('AB Manual - external version.pdf')")
  )  ## end navbarPage
)
