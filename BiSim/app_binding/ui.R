...
navbarPage(
  ...
  #                 numericInput("ki_CT", label = HTML('<FONT size = "2pt"> KI (K<sub>D</sub> of competition partner for partner 1) (units))'), value = 1000)
  #                 ),
  # 
  #               div(
  #                 style = "margin-top:0px;margin-bottom: 30px",
  #                 sliderInput("pKdcoat_CT",  label = div (style = "font-size:14px;","KI range to plot (-log pM)"), min=0, max=12, value=c(6,8), step=0.1)
  #               )
  #           # )
  #       ),
  #       #block 5
  ...
  #       #   width = 2,
  # 
  #         div( style = "display: inline-block;vertical-align:top; margin-bottom:0px;font-size:16px;margin-top:-0px",
  ...
  #                                                choices = list("Competing partner", "Partner 2"),
  #                                                selected = "Partner 2")),
  # 
  # 
  #                          column(3, numericInput('A_first_var_value', label  = HTML("Value 1 for K<sub>D</sub> (pM)"),
  #                                                 value= 0.0001)),
  #                          column(3, numericInput('A_first_var_value2', label = HTML("Value 2 for K<sub>D</sub> (pM)"), value= 100)),
  # 
  # 
  #                   ),# end fluidrow
  # 
